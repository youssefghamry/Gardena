...
if ( have_posts() ) {
	...
	while ( have_posts() ) {
		...
		BoldThemesFrameworkTemplate::$pf_before_image = boldthemes_rwmb_meta( BoldThemesFramework::$pfx . '_before_image', 'type=image&size=full' );
		BoldThemesFrameworkTemplate::$pf_after_image = boldthemes_rwmb_meta( BoldThemesFramework::$pfx . '_after_image', 'type=image&size=full' );
		BoldThemesFrameworkTemplate::$pf_before_after_text	= boldthemes_rwmb_meta( BoldThemesFramework::$pfx . '_before_after_text' );

		$featured_image = '';
		if ( !isset( BoldThemesFrameworkTemplate::$pf_before_image['ID']) && has_post_thumbnail() && boldthemes_get_option( 'hide_headline' ) ) {
